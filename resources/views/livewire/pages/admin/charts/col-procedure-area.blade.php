...
$procedure_area = computed(fn () => (new ColumnChartModel())
...
<div class="p-3 md:p-2.5 sm:p-2">
  ...
  <div class="w-full p-6 h-60">
    <livewire:livewire-column-chart key="{{ $this->procedure_area->reactiveKey() }}" :column-chart-model="$this->procedure_area"/>
  </div>
</div>
